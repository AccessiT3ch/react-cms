...
export const ADD_ACTION = "model/add";
export const REMOVE_ACTION = "model/remove";
export const UPDATE_ACTION = "model/update";
...
export const addModel = modelSlice.actions[ADD_ACTION];
export const removeModel = modelSlice.actions[REMOVE_ACTION];
export const updateModel = modelSlice.actions[UPDATE_ACTION];
